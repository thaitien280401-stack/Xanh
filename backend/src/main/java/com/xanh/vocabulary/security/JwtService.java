...
public class JwtService {
    ...
    public String generateAccessToken(UserDetails userDetails, UUID userId) {
        ...
        return buildToken(extraClaims, userDetails, appProperties.getJwt().getAccessExpirationMs());
    }

    public String generateRefreshToken(UserDetails userDetails) {
        return buildToken(new HashMap<>(), userDetails, appProperties.getJwt().getRefreshExpirationMs());
    }
